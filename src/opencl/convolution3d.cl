                             ...
                             int3 offset)
{
	...
	/* { */
	/* 	if(isnan(values[i])) 	printf("b %d %d %d %d %d %d %d %f\n", i, get_global_id(0), get_global_id(1), get_global_id(2), get_local_id(0), get_local_id(1), get_local_id(2), values[i]); */
